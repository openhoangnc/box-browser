...
class Fragment_settings_Filter : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        filter_01?.title =
            sp.getString("icon_01", activity?.resources?.getString(R.string.color_red))
        val filter_02 = findPreference<Preference>("filter_02")
        filter_02?.title =
            sp.getString("icon_02", activity?.resources?.getString(R.string.color_pink))
        val filter_03 = findPreference<Preference>("filter_03")
        filter_03?.title =
            sp.getString("icon_03", activity?.resources?.getString(R.string.color_purple))
        val filter_04 = findPreference<Preference>("filter_04")
        filter_04?.title =
            sp.getString("icon_04", activity?.resources?.getString(R.string.color_blue))
        val filter_05 = findPreference<Preference>("filter_05")
        filter_05?.title =
            sp.getString("icon_05", activity?.resources?.getString(R.string.color_teal))
        val filter_06 = findPreference<Preference>("filter_06")
        filter_06?.title =
            sp.getString("icon_06", activity?.resources?.getString(R.string.color_green))
        val filter_07 = findPreference<Preference>("filter_07")
        filter_07?.title =
            sp.getString("icon_07", activity?.resources?.getString(R.string.color_lime))
        val filter_08 = findPreference<Preference>("filter_08")
        filter_08?.title =
            sp.getString("icon_08", activity?.resources?.getString(R.string.color_yellow))
        val filter_09 = findPreference<Preference>("filter_09")
        filter_09?.title =
            sp.getString("icon_09", activity?.resources?.getString(R.string.color_orange))
        val filter_10 = findPreference<Preference>("filter_10")
        filter_10?.title =
            sp.getString("icon_10", activity?.resources?.getString(R.string.color_brown))
        val filter_11 = findPreference<Preference>("filter_11")
        filter_11?.title =
            sp.getString("icon_11", activity?.resources?.getString(R.string.color_grey))
        filter_01?.onPreferenceChangeListener =
        ...
        filter_02?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_03?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_04?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_05?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_06?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_07?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_08?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_09?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_10?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
        ...
        filter_11?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference, newValue ->
